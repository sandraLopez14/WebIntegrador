        ...
        <div class="container-hero">
            <div class="container hero">
                ...
                <div class="container-logo">
                    ...
                    <h1 class="logo"><a href="vistas/PagoExitoso.jsp">Medic Compras</a></h1>        
                </div>
 ...
 <div class="login-box">
        ...
        <form>
             <div class="profile-img">
                <img src="img/perfil.jpg" alt="Profile Image"/>
            </div>
            <div class="textbox">
                <input type="text" placeholder="Nombres completos" name="usuario" required/>
            </div>
             <div class="textbox">
                <input type="text" placeholder="Apellidos completos" name="usuario" required/>
            </div>
             <div class="textbox">
            ...
            <div class="textbox">
                <input type="password" placeholder="Rol" name="rol" required/>
            </div>
